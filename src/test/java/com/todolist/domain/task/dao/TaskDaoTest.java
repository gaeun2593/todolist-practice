...
////        // Act: 특정 TASK 조회
////        Task retrievedTask = taskDao.getTaskByCategory(testCategoryId);
////
////        // Assert: 조회된 값 검증
////        Assertions.assertNotNull(retrievedTask, "To Do List가 존재해야 합니다.");
////        Assertions.assertEquals(TEST_CONTENTS, retrievedTask.getContents(), "내용이 일치해야 합니다.");
////    }
//
//    /**
...
////        // 업데이트된 데이터 조회 후 검증
////        Task retrievedTask = taskDao.getTaskByCategory(testCategoryId);
////        Assertions.assertEquals(TaskStatus.COMPLETED, retrievedTask.getStatus(), "status가 \"COMPLETED\"로 변경되어야 합니다.");
////    }
//
//    /**
...
////        TaskAndNicknameDto softDeleteTask = new TaskAndNicknameDto(0, 0, TEST_NICKNAME);
////
////        // Act: 사용자 정보 업데이트
////        boolean isUpdated = taskDao.softDeleteTask(softDeleteTask);
////
////        // Assert: 업데이트 결과 확인
////        Assertions.assertTrue(isUpdated, "To Do List 삭제 정보가 성공적으로 수정되어야 합니다.");
////
////        // 업데이트된 데이터 조회 후 검증
////        List<TaskWithDetailsDto> retrievedTask = taskDao.getAllTasks();
////        Assertions.assertEquals(1, retrievedTask.get(0).getIsDeleted(), "is_deleted가 1로 변경되어야 합니다.");
////    }
//
//    /**
